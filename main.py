...
class SafeAreaBoxLayout(BoxLayout):
    def __init__(self, **kwargs):
        self._safe_padding = [0, 0, 0, 0]
        super().__init__(**kwargs)
        self.update_safe_padding()
        Window.bind(on_resize=self.on_window_resize)

    def get_safe_area_padding(self):
        try:
            if platform == 'ios':
                # iOS safe areas
                if self.is_landscape():
                    return [dp(44), dp(0), dp(44), dp(0)]
                else:
                    return [dp(0), dp(20), dp(0), dp(34)]
            elif platform == 'android':
                if self.is_landscape():
                    return [dp(0), dp(0), dp(0), dp(0)]
                else:
                    return [dp(0), dp(24), dp(0), dp(0)]
            else:
                return [dp(0), dp(0), dp(0), dp(0)]
        except:
            return [dp(0), dp(0), dp(0), dp(0)]
    ...
    def update_safe_padding(self):
        try:
            new_padding = self.get_safe_area_padding()
            if new_padding:
                if isinstance(new_padding, (list, tuple)) and len(new_padding) == 4:
...
class HelpScreen(Screen):
    ...
    def on_leave(self, *args):
        ...
        except Exception as e: (print(f"Bottom sheet close warning: {e}"))
    ...
    def open_bottom_sheet(self, *args):
        try:
            ...
            if bottom_sheet.state == "close":
                bottom_sheet.open()
        except Exception as e: print(f"ERROR opening bottom sheet: {e}")
    ...
    def close_bottom_sheet(self, *args):
        try:
            ...
            if bottom_sheet.state != "close":
                bottom_sheet.dismiss()
        except Exception as e: print(f"ERROR closing bottom sheet: {e}")
    ...
    def share_khanit(self, *args):
        ...
        share_text = (
            "Android:\n"
            "https://play.google.com/store/apps/details?id=org.khanit\n\n"
            "iOS:\n"
        ...
        try:
            ...
            if platform == "android":
                try:
                    ...
                    print(f"Android sharing error: {e}")
                    webbrowser.open("https://play.google.com/store/apps/details?id=org.khanit")
                    return
            ...
            print(f"ERROR sharing Khanit: {e}")
    ...
    def open_feedback_email(self, *args):
        ...
        try:
            ...
            print(f"Opening feedback email on platform: {platform_name}")
            ...
            if platform_name == "android":
                try:
                    ...
                    current_activity = (PythonActivity.mActivity)
                    current_activity.startActivity(intent)
                    print("Android email application opened.")
                    return
            ...
            # IOS
                ...
                webbrowser.open(mailto_url)
                print("iOS mail application requested.")
                return
            else:
                mailto_url = (
                        "mailto:" + recipient +
                ...
                webbrowser.open(mailto_url)
                print("Desktop mail application requested.")
                return
        except Exception as e:
    ...
    def update_theme_ui(self, *args):
        try:
            ...
            print(
                "LimbuNumberTrace theme UI refreshed:",
                MDApp.get_running_app().theme_cls.theme_style
            )
        except Exception as e:
...
class HistoryScreen(Screen):
    ...
    def build_ui(self):
        main_layout = SafeAreaBoxLayout(orientation='vertical', padding=dp(10))
    ...
    def add_history_record(self, record):
        ...
        if record[1] or record[2]:
            ...
            lim_text = (
                f"Kirat:  "
                f"{lim_expression_display}"
                f" = "
                f"{lim_result_display}"
            )
        ...
        if record[3] or record[4]:
            ...
            nep_expression_display = convert_to_nepali(
                record[3] or ''
            )

            nep_result_display = convert_to_nepali(
                record[4] or ''
            )

            nep_text = (
                f"Nepali: "
                f"{nep_expression_display}"
                f" = "
                f"{nep_result_display}"
            )
